...
func TestReadYaml(t *testing.T) {
	...
	a.Equal(Install{Commands: []string{
		"mkdir -p [[install-root]]",
		"curl [[url]] | tar -C [[install-root]] -x"}}, manifest.Install)
